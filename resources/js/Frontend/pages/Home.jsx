  ...
  return (
    <div className="space-y-24 pb-24">
      ...
      <section className="relative h-[85vh] min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        {/* Hero Content */}
        <Reveal className="container relative z-10 px-4 lg:px-8 text-center space-y-8" direction="up" delay={200}>
      ...
      <Reveal className="container px-4 lg:px-8 space-y-16">
      ...
      {/* Featured Projects */}
      <Reveal className="container px-4 lg:px-8 space-y-16" delay={200}>
        <div className="text-center space-y-4 max-w-2xl mx-auto">
      ...
      {/* Call to Action */}
      <Reveal className="container px-4 lg:px-8" direction="none">
